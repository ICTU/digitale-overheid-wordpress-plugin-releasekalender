...
//        if ( $currentyear == $year_start ) {
//          $totop = '<div class="back_to_top" style="border: 10px solid red; clear: both;"><p><a href="#top">' . __( "Naar boven", 'rijksreleasekalender' ) . '</a></p></div>';
//        }

        $currentyearstring = $totop . '<h2 id="' . $theid . '">' . $currentyear . '</h2>';
